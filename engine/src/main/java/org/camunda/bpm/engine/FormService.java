...
public interface FormService {
     ...
     *
     * @param processDefinitionId the id of the process definition, cannot be
     * null.
     * @param businessKey a key that uniquely identifies the process instance in
     * the context or the given process definition.
    ...
    void resolveGenericForm(String taskId, Map<String, Object> variables);

    void completeGenericForm(String taskId, Map<String, Object> variables);
}
